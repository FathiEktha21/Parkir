            ...
            <div class="card-body">
              <form action="simpan-parkir.php" method="POST">
                <div class="form-group">
                  ...
                  <input type="text" name="plat_nomor" id="plat_nomor" placeholder="Masukkan Nomor Plat" class="form-control" style="text-transform: uppercase">
                </div>
                
                  <div class="form-group">
                  <label>Jenis Kendaraan :</label>
                  <br>
                  <select name="jenis_kendaraan" id="id_kendaraan" name='id_kendaraan'>
